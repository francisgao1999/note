...
$encryptionKeyFromEnv = 'xiaohei';
$siteIcon = 'https://ik.imagekit.io/wyh9v7s9y/favicon1.ico?updatedAt=1724742703817';
$siteDomain = 'https://go.tone.nyc.mn/note';
...
<style>
body {
  background-image: url(https://ik.imagekit.io/eu1ixywi3/47482bcb3a294e868546d6c73f1e7ca8.jpg?updatedAt=1736249837464) !important;
}
...
<body class="bg-gradient-to-r font-sans min-h-screen flex items-center justify-center">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_GET['confirm'])) {
  ...
  <span id="currentExpiry" class="text-sm ml-2">当前设置：0天0时10分0秒</span>
  </label>
  ...
  <div class="flex-1">
  <div class="relative">
  <input type="number" id="minutes" name="expiry_minutes" min="0" max="59" value="10"
  class="shadow appearance-none border rounded w-full py-2 pl-3 pr-12 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
  oninput="validateAndUpdateTime()">
...
<!-- 新年灯笼 -->
<script  src="https://share.cfon.us.kg/html-tool/denglong/denglong2.js"></script>
<!-- 点击特效 -->
<script src="https://share.cfon.us.kg/html-tool/word/word.js"></script>
